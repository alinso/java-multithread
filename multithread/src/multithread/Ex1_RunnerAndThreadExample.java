...
// This is another thread from main and Runner1, in main method these 3 threads
...
public class Ex1_RunnerAndThreadExample {
	...
	public static void main(String[] args) {
		...
		// By using join, we make sure that program is waiting for these threads to
		// finish
		// At this point main thread finished to count, and does not terminate program
		// until other two finish their jobs.
		try {
			t1.join();
			t2.join();
